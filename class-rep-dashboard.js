...
(function () {
    ...
    async function fetchUsersList() {
        ...
        try {
            ...
            console.error('Failed to fetch users list via manage-users Edge Function:', err);
            showUsersError(
                (err.message || 'Unable to load user accounts.') +
                ' — Ensure the manage-users Edge Function is deployed and reachable.'
            );
        }
    }
